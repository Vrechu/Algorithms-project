...
class AlgorithmsAssignment : Game
{
	...
	public AlgorithmsAssignment() : base(800, 600, false, true, -1, -1, false)
	{
		...
		if (_dungeon != null)
		{
            ...
            /*Thread thread = new Thread(() => _dungeon.Generate(MIN_ROOM_SIZE));  //revert!!
            thread.Start();*/
        }
		...
		_agent = new SufficientAgent(_graph);
	...
	public static int DistanceSquared(int value1, int value2)
	{
		return (value1 - value2) * (value1 - value2);
	}

	public static int Highest(int value1, int value2)
    {
		if (value1 > value2)
		{
			return value1;
	...
	public static int Lowest(int value1, int value2)
	{
		if (value1 < value2)
		{
			return value1;
